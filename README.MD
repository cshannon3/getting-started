...
To commit code, press the "+" button to move code the unstaged area to the staged area. Add a message in the box to describe what changes you made. Then click the check button to commit the changes.
